...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('temp/custom/style.css') }}">
    ...
    <meta charset="utf-8">
    <title>Global Finesse Trade | @yield('title')</title>
    ...
    <meta property="og:image:secure_url" content="{{ asset('img/share.jpg') }}">
    <meta property="og:image:type" content="image/jpg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="1200">
    <meta name="theme-color" content="#008bff">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@fusionxpertrade">
    <meta name="twitter:creator" content="@fusionxpertrade">
    <meta name="twitter:title" content="CFD Trading — Trading on Stocks, Gold, Oil, Indices | ReGlobal Finesse Trade">
    <meta name="twitter:image" content="{{ asset('img/share.jpg') }}">
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('img/fond_57px.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('img/fond_72px.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('img/fond_114px.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('img/fond_144px.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{ asset('img/fond_57px.png') }}">
    ...
    <script src="{{ asset('temp/custom/js/app1bca.js') }}"></script>
    @yield('head')
</head>

<body class="lang-en new-inner home-page-new" data-locale="en">
    <div class="loader_bg">
        <div class="loader"></div>
    </div>

    <header class="">
        <section style="background-color:#000;" class="topbar" id="topbar">
            <div class="container">
                <div class="topbar__items d-flex align-center space-between">
                    ...
                    <div class="menu-items-topbar d-inline-block ml-auto">
                        <ul class="fm m-0 topbar-content d-inline-block">
                            ...
                            <li><a title="contact us" href="{{ route('contacts') }}" class="contact">Contact us</a></li>
                        </ul>
                    ...
                    <div class="bars-btn-cnt hidden-lg">
                        <ul class="bars-btn">
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
            ...
            <nav class="sidemenu">
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex space-even mb-2 hidden-md">
                        ...
                        <span class="fc-grey">|</span>
                        <a title="contact us" href="{{ route('contacts') }}" class="contact">Contact us</a>
                    </div>
        ...
        <nav class="menu visible-lg" id="desktopMenu">
            <div class="container">
                ...
                <div class="sub-menu slide-top" id="sub-menu">
                    <div class="smi cfd">
                        ...
                        <div class="smi about-us">
                            <div class="listmenu">
                                <ul class="listmenu__list">
                                    ...
                                    <li><a title="etfs" href="{{ route('etfs') }}">ETFs</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="smi platform">
                        <div class="platform_nav pr-2">
                            <hr class="mt-1">
                            <div class="d-flex">
                                <div class="platform_nav_item">
                                    ...
                                    <div class="devices">
                                        ...
                                        <a title="Android" href="#" rel="noopener" target="_blank" alt="Android">
                                            <i class="fa fa-lg fa-android" aria-hidden="true"></i>
                                        </a>
                                        <a title="iOS" href="#" rel="noopener" target="_blank" alt="iOS">
                                            <i class="fa fa-lg fa-apple" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="platform_nav platform_nav--grey">
                            <div class="inl">
                                <a class="main_page mb-1" title="Platform Versions" href="#">Platform Versions
                                    <i class="fa fa-arrow-right arrow ml-1" aria-hidden="true"></i>
                                </a>
                                <hr class="mt-0 mb-2 page_speed_1337814207">
                                <div class="sub">
                                    <div>
                                        <ul class="listmenu__list mb-2">
                                            <li>
                                                <a href="#" title="Web" target="_blank">
                                                    <i class="fa fa-lg fa-desktop mr-1" aria-hidden="true"></i>
                                        ...
                                        <ul class="listmenu__list">
                                            <li>
                                                <a href="#" title="Desktop">
                                                    <i class="fa fa-lg fa-windows mr-1" aria-hidden="true"></i>
                                                    <span>Desktop</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" rel="noopener" target="_blank" title="Android">
                                                    <i class="fa fa-lg fa-android mr-1" aria-hidden="true"></i>
                                                    <span>Android</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" rel="noopener" target="_blank" title="iOS">
                                                    <i class="fa fa-lg fa-apple mr-1" aria-hidden="true"></i>
                                                    <span>iOS</span>
                                                </a>
                                            </li>
                                        </ul>
                    ...
                    <div class="smi about-us">
                        ...
                        <div class="listmenu">
                            ...
                            <div class="frst">
                                <div class="contacts">
                                    <a title="open chat" href="#" class="chat-window-open">
                                        <i class="fa fa-2x fa-commenting imm" aria-hidden="true"></i>
                                        <span>Live Chat</span>
                                    </a>
                                </div>
                                <div class="contacts">
...
_smartsupp.key = '7c5fea0a78aff6b343fa2def55095647023516d6';
window.smartsupp||(function(d) {
  ...
  c.src='https://www.smartsuppchat.com/loader.js?';s.parentNode.insertBefore(c,s);
    ...
    <div id="notification-1" class="notification" style="background-color: #d0ebff;">
