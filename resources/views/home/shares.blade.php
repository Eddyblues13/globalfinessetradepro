...
<section class="content">
    ...
    <section style="background-image:url(temp/custom/img/fx.png
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="text-uppercase mb-0">Shares</h1>
                    <div class="mb-3">
                        <div class="breadc"></div>
                        <script data-cfasync="false"
                            src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
                        <script type=application/ld+json>
                            { "@context": "http://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type":"ListItem","position":1,"item":{"@id":"https:\/\/fondex.pro\/en\/","name":"Global Finesse Trade Trade"}},{"@type":"ListItem","position":2,"item":{"@id":"https:\/\/fondex.pro\/en\/company","name":"Company"}}] }
                        </script>
                    </div>
                    ...
                    <p>Shares are units of equity ownership interest in a corporation that exist as a financial asset
                        providing for an equal distribution in any residual profits, if any are declared, in the form of
                        dividends. Shareholders may also enjoy capital gains if the value of the company rises.</p>
    ...
    <section style="background-color:#fff; color:#000" class="pt-4 pb-4 lowest-commission">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h6 class="fs-23 mb-3 mt-4"> One of the primary goals of Global Finesse Tradeis to provide the best
                    ...
                    <a href="" title="Learn About Global Finesse TradeCommissions" class="fc-fondex fw-500"
